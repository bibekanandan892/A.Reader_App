package com.isu.jetareader.screens.update
...
import com.isu.jetareader.utils.formatDate
...
fun BookUpdateScreen(
    ...
    Scaffold(topBar = {
        ...
        val bookInfo =
            produceState<DataOrException<List<MBook>, Boolean, Exception>>(initialValue = DataOrException(
                data = emptyList(),
                true,
                Exception(""))) {
        ...
        Surface(modifier = Modifier
            ...
            Column(modifier = Modifier.padding(top = 3.dp),
                ...
                if (bookInfo.loading == true) {
                    ...
                    if (viewModel.data.value.data != null && !viewModel.data.value.data.isNullOrEmpty()) {
                        Surface(modifier = Modifier
                            .padding(2.dp
                            )
                            .fillMaxWidth(),
...
fun ShowSimpleForm(
    ...
    Row {
        ...
        val bookToUpdate = hashMapOf("finished_reading_at" to isFinishedTimeStamp,
